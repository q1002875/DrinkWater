...
//    var aaa:String?
//    var image:String = ""
//    init(coordinate:CLLocationCoordinate2D,title:String,subtitle:String,aaa:String) {
...
//    func mapView(_ mapView: MKMapView, didSelect view: myAnnotation) {
//        if let annotation = view.aaa{
...
//                                // 加上地圖標註
//                                let annotation = myAnnotation( coordinate: (placemark.location?.coordinate)!, title: self.drinkname[index], subtitle: self.address[index], aaa: self.address[index])
